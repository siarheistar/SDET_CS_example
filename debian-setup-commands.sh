...
################################################################################
# Allure Server Setup Script for Debian 12
# Run this on your Debian VM to install Docker and Allure Server
################################################################################
...
echo -e "${YELLOW}Step 4/10: Adding Docker's GPG key...${NC}"
...
echo -e "${YELLOW}Step 5/10: Adding Docker repository...${NC}"
echo \
